...
readonly SERVICE_NAME=iot-consumer-conservatory-values
...
cp -p ../../iot-consumer-conservatory-values/*.py ./target
cp -p ../../iot-consumer-conservatory-values/requirements.txt ./target
